...
#define BB LT(_ADJUST,KC_B)
#define GG LT(_COLEMAKDH,KC_G)
#define HH LT(_COLEMAKDH,KC_H)


const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* QWERTY */
    KC_Q,    ALT_W,    CMD_E,    KC_R,    KC_T,            KC_Y,    KC_U,  CMD_I,    ALT_O,   KC_P,
    KC_A, KC_S,    CNTRL_D,    SFT_F,    GG,            HH,    SFT_J,  CNTRL_K,    KC_L,   KC_SCLN,
    KC_L, KC_X,    KC_C,    KC_V,    BB,            KC_N,    KC_M,  KC_COMM, KC_DOT, KC_SLSH,
  ...
  [_ADJUST] = LAYOUT(
    ...
    KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,
                               _______, _______,     _______, _______
        ),
...
const uint16_t PROGMEM combo_tab[] = {KC_P, KC_F, COMBO_END};
const uint16_t PROGMEM combo_esc[] = {KC_S, KC_T, COMBO_END};
const uint16_t PROGMEM combo_backspace[] = {KC_U, KC_L, COMBO_END};
const uint16_t PROGMEM combo_quot[] = {KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM combo_backslash[] = {KC_E, KC_K, COMBO_END};
